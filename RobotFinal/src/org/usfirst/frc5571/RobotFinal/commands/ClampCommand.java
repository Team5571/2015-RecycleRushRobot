...
public class  ClampCommand extends Command {
    ...
    public enum  GripperState {
    	 UNKNOWN, OPENING, CLOSING, OPEN, CLOSED;
    }
    
    //This will hold the state of the gripper and be used for deciding when to light the gripper
    // closed light
    ...
    protected void initialize() {
		...
		position_held = false;
		gripperState = GripperState.UNKNOWN;
