...
public class RobotMap {
    ...
    public static DigitalOutput clampLight;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    	...
    	clampLight = new DigitalOutput(0);
    	
        driveTrainCANTalonRearLeft = new CANTalon(3);
        
        
        driveTrainCANTalonFrontLeft = new CANTalon(4);
        
        
        driveTrainCANTalonRearRight = new CANTalon(1);
        
        
        driveTrainCANTalonFrontRight = new CANTalon(2);
