...
import org.usfirst.frc5571.RobotFinal.VariableSet;
...
public class DriveTrain extends Subsystem {
	...
	VariableSet variableset = Robot.variableset;
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    double triggerTwist;
    static double deadZone = VariableSet.deadZone;
    static double rotateReduction = VariableSet.rotateReduction ;
    static double magnitudeReduction = VariableSet.magnitudeReduction;
	...
	public void mecanumDrive_Polar() {
	    double triggerTwist = (((Robot.oi.xboxController.getRawAxis(2) * -1) + Robot.oi.xboxController.getRawAxis(3)) * (rotateReduction));  
	    robotDrive41.mecanumDrive_Polar(correctDeadSpot( Robot.oi.xboxController.getMagnitude() * (magnitudeReduction)), -Robot.oi.xboxController.getDirectionDegrees(), triggerTwist);
	}
