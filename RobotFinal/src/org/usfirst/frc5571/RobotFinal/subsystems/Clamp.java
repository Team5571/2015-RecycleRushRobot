...
public class Clamp extends Subsystem {
	...
	int profile;
	boolean servoHereFlag, clampCurrentState;
...
//	}
	...
	//Checks to see if the current limit has been reached, if true sets clampCurrentState to true.
	public void clampCurrent_Light(){ 
		if (cANTalonClamp.getOutputCurrent() > MAX_CLAMP_CURRENT) {
			clampCurrentState = true;
			
		} else {
			clampCurrentState = false;
		}	
	}
