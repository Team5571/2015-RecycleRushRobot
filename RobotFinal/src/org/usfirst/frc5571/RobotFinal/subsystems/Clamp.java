...
public class Clamp extends Subsystem {
	...
	public DigitalOutput clampLight = RobotMap.clampLight;
	...
	int profile;
	boolean servoHereFlag, gripperLightState;
...
//		cANTalon1.setPID(p, i, d, f, izone, ramprate, profile);
	...
	public void turnOnGripperCLosedLight(){
		clampLight.set(true);
		gripperLightState = true;
	}
	
	public void turnOffGripperCLosedLight(){
		clampLight.set(false);
		gripperLightState = false;
	}
	
	//Ran during the end of each Clamp Command, checks the clampCurrentState in clampCurrent_Light(), if true turns the light on.
//	public void clampLight_test() { 
//		if (clampCurrentState) {
//			clampLight.set(true);
//			
//		} 
//		else {
...
//	}
	...
	public void showCanTalonStatus() {
		...
		double Iaccum = cANTalonClamp.GetIaccum();
			...
			SmartDashboard.putBoolean("Gripper Light State", gripperLightState);
	}
