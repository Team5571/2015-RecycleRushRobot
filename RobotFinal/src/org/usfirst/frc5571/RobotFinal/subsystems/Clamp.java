...
public class Clamp extends Subsystem {
	...
	double axis;
	static double MAX_CLAMP_CURRENT = VariableSet.MAX_CLAMP_CURRENT;  // limit current to 10A x 12V = 120W  mini CIM motor is rated at 230W and 86A Stall Current
	static double CLOSE_SPEED = VariableSet.CLOSE_SPEED;  // change in encoder position  per 10 ms
	static double OPEN_SPEED = VariableSet.OPEN_SPEED;  // change in encoder position  per 10 ms
	double p;
	double i;;
	double d;
	double f;
