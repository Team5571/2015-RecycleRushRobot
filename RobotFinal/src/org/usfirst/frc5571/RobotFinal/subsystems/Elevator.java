...
public class Elevator extends Subsystem {
    ...
    // here. Call these from CommandsS.
	 double axis;
		static double MAX_ELEV_CURRENT = VariableSet.MAX_ELEV_CURRENT;  // limit current to 3A  motor is rated at 36.91W 
		static double DOWN_SPEED = VariableSet.DOWN_SPEED;  // position change per 10 ms
		static double UP_SPEED = VariableSet.UP_SPEED;  // position change per 10 ms
		double p;
		double i;;
		double d;
		double f;
